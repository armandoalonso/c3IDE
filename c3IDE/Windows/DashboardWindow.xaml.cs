...
namespace c3IDE.Windows
{
    ...
    public partial class DashboardWindow : UserControl, IWindow
    {
        ...
        private void AddonListBox_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {

        }

        private void AddonFilter_TextChanged(object sender, TextChangedEventArgs e)
        {
